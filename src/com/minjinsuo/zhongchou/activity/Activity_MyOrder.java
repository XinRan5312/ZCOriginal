...
import com.minjinsuo.zhongchou.fragment.Fragment_child_MyOrder;
...
public class Activity_MyOrder extends Activity_Base {
	...
	protected void initView() {
		setTitleText(getString(R.string.my_support_title));
		setTitleBack();
	...
	private class AttentionPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int arg0) {
			switch (arg0) {
			case 0:
				return Fragment_child_MyOrder.getInstance(true);
			case 1:
				return Fragment_child_MyOrder.getInstance(false);
			default:
				return null;
			}
		}
