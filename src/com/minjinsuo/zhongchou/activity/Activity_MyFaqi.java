...
import com.minjinsuo.zhongchou.fragment.Fragment_child_Faqi;
 ...
 *         2016年6月22日
 */
public class Activity_MyFaqi extends Activity_Base {
	...
	protected void initView() {
		setTitleText(getString(R.string.my_faqi_title));
		setTitleBack();
	...
	private class AttentionPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int arg0) {
			switch (arg0) {
			case 0:
				return Fragment_child_Faqi.getInstance(true);
			case 1:
				return Fragment_child_Faqi.getInstance(false);
			default:
				return null;
			}
		}
