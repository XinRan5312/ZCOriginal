 ...
 *
 */
public class Activity_Navigation extends Activity_Base implements
		OnClickListener {
	ViewPager vp;
	...
	protected void initListener() {
		// 获取间距
		btn.getViewTreeObserver().addOnGlobalLayoutListener(
				new OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						// 把当前的事件给移除监听.
						btn.getViewTreeObserver().removeGlobalOnLayoutListener(
								this);
						// int[] ints=new int[2];
						...
						// System.out.println("-----间距-------" + btn_bottom);
					}
				});
	...
	public void onClick(View v) {
		...
		SharedPreferUtils.setNotFirstStart(this);
		finish();
	}
