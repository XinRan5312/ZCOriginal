 ...
 * 收货地址列表
 */
public class Activity_AddressManager extends Activity_Base implements
		OnItemClickListener {
				...
				new OnClickListener() {
					...
					public void onClick(View v) {
						startActivityForResult(new Intent(getContext(),
								Activity_ReceiverAddress.class), 001);
					}
				});
	...
	public class AddressAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			holder.tv_delete.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					final Dialog dialog_del = DialogUtils.createTwoBtnDiolog(
							Activity_AddressManager.this, "确定删除改收货地址？");
			...
			holder.tv_change.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					Intent intent = new Intent(Activity_AddressManager.this,
							Activity_ReceiverAddress.class);
		...
		public void startRequestSetDefault(final String id, final int position) {
			...
			NetWorkRequestManager.sendRequestPost(
					Activity_AddressManager.this, true, request,
		...
		public void startRequestDele(String id) {
			...
			NetWorkRequestManager.sendRequestPost(
					...
					DelUserAddressResponse.class, new MyRequestCallBack() {
						...
						@Override
						public void onSuccess(ResponseSupport response) {
							ToastUtil.showToast(Activity_AddressManager.this,
									"删除成功");
