...
/**
 * 我的关注/发起人、领头人详情页——数据适配器
 */
public class Adapter_MyAttention extends BaseAdapter {

	public Context context;
	private ArrayList<ElementUPrjList> tenderList;
	private ImageOptions options;

	public Adapter_MyAttention(Context context) {
		super();
		this.context = context;
		// 初始化
		tenderList = new ArrayList<ElementUPrjList>();
	...
	public void setData(List<ElementUPrjList> tenderList) {
		if (tenderList != null) {
	...
	public ArrayList<ElementUPrjList> getData() {
		return tenderList;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ElementUPrjList info = tenderList.get(position);
		if (info != null) {
			...
			holder.amount.setText(StringUtils.exceedW(info.getSuppedAmt4Succ())
					+ "元");
			if (info.getPrjEndSurplusDays() != null) {
				holder.tv_day_haveleft.setText(info.getPrjEndSurplusDays()
						+ "天");
			}
			// 投资进度
