 ...
 * 众筹列表数据适配器OK
 */
public class Adapter_CrowdList extends BaseAdapter {

	public Context context;
	private ArrayList<ElementPrjList> tenderList;
	private ImageOptions options;

	public Adapter_CrowdList(Context context) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (info != null) {
			...
			holder.amount.setText(info.getPrjAmount());
			// 已支持金额
			holder.supp_num.setText(info.getSuppedAmt4Succ());
			// 出让股份比例
