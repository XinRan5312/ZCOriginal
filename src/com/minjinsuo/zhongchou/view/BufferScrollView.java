 ...
 *         2016年6月2日
 */
public class BufferScrollView extends ScrollView {
	...
	public BufferScrollView(Context context) {
		super(context);
	}

	public BufferScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	public void commOnTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			float nowY = ev.getY();
			/**
			 * size=4 表示 拖动的最大距离为屏幕的高度的1/4(同时起到阻尼的效果)
			 */
