...
package com.minjinsuo.zhongchou.widget.wheelview;

import java.util.LinkedList;
import java.util.List;

import com.minjinsuo.zhongchou.R;
import com.minjinsuo.zhongchou.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawShadows(Canvas canvas) {
		...
		/*
		 * 设置阴影高度 by zp 2016-04-08
		 */
		int height = (int) (getVisibleItems() / 2 * getItemHeight());
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.center_line_border));
		// 设置线宽
