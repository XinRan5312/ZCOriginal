 ...
 * 
 */
public class GetPrjInfoByIdResponse extends ResponseSupport {
	...
	private String pctSoldStock;
	private String buyedCount;
	private String prjNoticeCount;
	...
	public String getPrjNoticeCount() {
		return prjNoticeCount;
	}

	public void setPrjNoticeCount(String prjNoticeCount) {
		this.prjNoticeCount = prjNoticeCount;
	}
	 ...
	 * @return:出让股权比例
	 */
	public String getPctSoldStock() {
		return pctSoldStock;
	}

	public void setPctSoldStock(String pctSoldStock) {
		this.pctSoldStock = pctSoldStock;
	}
	 ...
	 * @return 距离结束小时数
	 */
	public String getEndHourCount() {
		return endHourCount;
	}

	public void setEndHourCount(String endHourCount) {
		this.endHourCount = endHourCount;
	}
	...
	/**
	 * @return 是否关注（0-未关注 1-关注）
	 */
	public String getIsAttion() {
		return isAttion;
	}

	public void setIsAttion(String isAttion) {
	 ...
	 * @return 项目介绍h5页面地址
	 */
	public String getPrjIntroH5Addr() {
		return prjIntroH5Addr;
	}

	public void setPrjIntroH5Addr(String prjIntroH5Addr) {
		this.prjIntroH5Addr = prjIntroH5Addr;
	}
	...
	/**
	 * @return 产品子类 10 普通 20 饕客约 40——公益
	 */
