 ...
 * 
 */
public class GetAttentionPrjListResponse extends ResponseSupport {

	/**
	 * @see net.zkbc.p2p.message.protocol.GetAttentionPrjListResponse#getAttPrjList
	 * 
	 */
	public static class ElementAttPrjList {
	...
	private List<ElementAttPrjList> attPrjList;

	public GetAttentionPrjListResponse() {
		super();
	 ...
	 * @return 关注项目列表
	 */
	public List<ElementAttPrjList> getAttPrjList() {
		return attPrjList;
	}

	public void setAttPrjList(List<ElementAttPrjList> attPrjList) {
		this.attPrjList = attPrjList;
	}
}