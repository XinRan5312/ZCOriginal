...
/**
 * 当前登录用户获取项目分页信息.服务端响应
 * 
 * @author 代码生成器v1.0
 * 
 */
public class GetPrjPageListForUserResponse extends ResponseSupport implements
		Serializable {

	/**
	 * @see net.zkbc.p2p.message.protocol.GetPrjPageListForUserResponse#getUPrjList
	 * 
	 */
	public static class ElementUPrjList implements Serializable {
	...
	private List<ElementUPrjList> uPrjList;

	public GetPrjPageListForUserResponse() {
		super();
	 ...
	 * @return 项目列表
	 */
	public List<ElementUPrjList> getUPrjList() {
		return uPrjList;
	}

	public void setUPrjList(List<ElementUPrjList> uPrjList) {
		this.uPrjList = uPrjList;
	}
}