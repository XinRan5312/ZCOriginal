 ...
 * 
 */
public class GetPrjInfoPageListResponse extends ResponseSupport implements
		Serializable {

	/**
	 * @see net.zkbc.p2p.message.protocol.GetPrjInfoPageListResponse#getPrjList
	 * 
	 */
	public static class ElementPrjList implements Serializable {
	...
	private List<ElementPrjList> prjList;

	public GetPrjInfoPageListResponse() {
		super();
	 ...
	 * @return 项目列表
	 */
	public List<ElementPrjList> getPrjList() {
		return prjList;
	}

	public void setPrjList(List<ElementPrjList> prjList) {
