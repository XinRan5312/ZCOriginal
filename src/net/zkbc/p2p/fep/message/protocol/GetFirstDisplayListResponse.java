 ...
 * 
 */
public class GetFirstDisplayListResponse extends ResponseSupport {

	/**
	 * @see net.zkbc.p2p.message.protocol.GetFirstDisplayListResponse#getDispPrjList
	 * 
	 */
	public static class ElementDispPrjList {
	...
	private List<ElementDispPrjList> dispPrjList;

	public GetFirstDisplayListResponse() {
		super();
		setMessageId("getFirstDisplayList");
	}
	 ...
	 * @return 首页项目列表
	 */
	public List<ElementDispPrjList> getDispPrjList() {
		return dispPrjList;
	}

	public void setDispPrjList(List<ElementDispPrjList> dispPrjList) {
		this.dispPrjList = dispPrjList;
	}
}