 ...
 * 
 */
public class GetHomePrjInfoListResponse extends ResponseSupport {

	/**
	 * @see net.zkbc.p2p.message.protocol.GetHomePrjInfoListResponse#getHomePrjList
	 * 
	 */
	public static class ElementHomePrjList {
	...
	private List<ElementHomePrjList> homePrjList;

	public GetHomePrjInfoListResponse() {
		super();
		setMessageId("getHomePrjInfoList");
	}
	 ...
	 * @return 项目列表
	 */
	public List<ElementHomePrjList> getHomePrjList() {
		return homePrjList;
	}

	public void setHomePrjList(List<ElementHomePrjList> homePrjList) {
		this.homePrjList = homePrjList;
	}
}